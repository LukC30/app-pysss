cand1 = input("Coloque o nome do candidato 1: ")
cand2 = input("Coloque o nome do candidato 2: ")
cand3 = input("Coloque o nome do candidato 3: ")
...
qtdVotos = int(input("Insira quantos eleitores irão votar na urna"))
...
urnaEletronica(candidatos, qtdVotos)
...
def contagemVotos(candidatos, votoCandidato):
    ...
    if cont1 > cont2 and cont1 > cont3:
        ...
        print("Empate tecnico entre todos os participantes da eleição")
    elif cont1 == cont2 and cont2 > cont3:
        print(f"Empate tecnico entre os participantes {candidatos[0]} e {candidatos[1]} da eleição")
    elif cont1 == cont3:
        print(f"Empate tecnico entre os participantes {candidatos[0]} e {candidatos[2]} da eleição")
    elif cont2 == cont3:
        print(f"Empate tecnico entre os participantes {candidatos[1]} e {candidatos[2]} da eleição")
